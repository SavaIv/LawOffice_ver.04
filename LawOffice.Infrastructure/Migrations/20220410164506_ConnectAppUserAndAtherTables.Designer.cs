...
namespace LawOffice.Infrastructure.Migrations
{
    ...
    [Migration("20220410164506_ConnectAppUserAndAtherTables")]
    partial class ConnectAppUserAndAtherTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LawOffice.Infrastructure.Data.Case", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LawOffice.Infrastructure.Data.CompanyInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LawOffice.Infrastructure.Data.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("LawOffice.Infrastructure.Data.InsideDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LawOffice.Infrastructure.Data.Instance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LawOffice.Infrastructure.Data.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LawOffice.Infrastructure.Data.OutsideDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LawOffice.Infrastructure.Data.Case", b =>
                {
                    b.HasOne("LawOffice.Infrastructure.Data.Identity.ApplicationUser", "User")
                        .WithMany("Cases")
            ...
            modelBuilder.Entity("LawOffice.Infrastructure.Data.InsideDocument", b =>
                {
                    b.HasOne("LawOffice.Infrastructure.Data.Instance", "Instance")
            ...
            modelBuilder.Entity("LawOffice.Infrastructure.Data.Instance", b =>
                {
                    b.HasOne("LawOffice.Infrastructure.Data.Case", "Case")
                        .WithMany("Instances")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LawOffice.Infrastructure.Data.Identity.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
